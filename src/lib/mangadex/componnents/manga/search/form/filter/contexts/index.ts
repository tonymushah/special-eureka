import { TagSearchMode, type ContentProfile, type ContentRating, type Demographic, type MangaStatus } from "@mangadex/gql/graphql"
...
export function mangaFilterParamsFromContentProfile(contentProfile: ContentProfile): MangaSearchFilterParams {
	return {
...
export function defaultMangaFilterParams(): MangaSearchFilterParams {
	...
	return mangaFilterParamsFromContentProfile(contentProfile);
}
