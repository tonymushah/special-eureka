...
export const Default: Story = {
    args: {
        ...
        description: "Lorem, ipsum dolor sit amet consectetur adipisicing elit. Eveniet dolorem, corporis neque placeat distinctio enim, nihil, doloremque iste quaerat expedita qui facere iure est ea obcaecati corrupti ab consectetur nam?",
        profileBanner,
        profilePicture
    }
};
