...
impl BlacklistScanlationGroupsMutations {
	...
	pub async fn block_one(&self, ctx: &Context<'_>, scanlation_group_id: Uuid) -> crate::Result<BlacklistedScanlationGroupObject> {
	...
	pub async fn block_many(&self, ctx: &Context<'_>, #[graphql(validator(min_items = 1))] scanlation_group_ids: Vec<Uuid>) -> crate::Result<Vec<BlacklistedScanlationGroupObject>> {
		let app_handle = ctx.get_app_handle::<tauri::Wry>()?.clone();
	...
	pub async fn unblock_many(&self, ctx: &Context<'_>, scanlation_group_id:Uuid) -> crate::Result<BlacklistedScanlationGroupObject> {
		let app_handle = ctx.get_app_handle::<tauri::Wry>()?.clone();
	...
	pub async fn unblock_batch(&self, ctx: &Context<'_>, #[graphql(validator(min_items = 1))] scanlation_group_ids:Vec<Uuid>) -> crate::Result<BlacklistedScanlationGroupObject> {
		let app_handle = ctx.get_app_handle::<tauri::Wry>()?.clone();
