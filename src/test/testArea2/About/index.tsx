...
export default function Overview(){
    return (
        <>
            <Text>Lorem ipsum dolor sit amet consectetur adipisicing elit. Amet quasi deserunt voluptatibus minima pariatur ipsum saepe harum iusto non. Mollitia harum nostrum quaerat velit atque error, officiis culpa odit omnis.</Text>
            <Text>Part2</Text>
