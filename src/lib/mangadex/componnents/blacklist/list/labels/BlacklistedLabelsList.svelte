<script lang="ts">
	...
	import { listBlacklistLabelsQueryGQLDocs } from "@mangadex/gql-docs/blacklist/labels";
	...
	let query = createInfiniteQuery(() => ({
		queryKey: ["blacklisted", "labels", "list", params],
		async queryFn({ pageParam }) {
			const res = await client
				.query(listBlacklistLabelsQueryGQLDocs, {
					params: pageParam
				})
				.toPromise();
			if (res.error) {
				...
				return res.data.blacklist.labels.list;
			} else {
