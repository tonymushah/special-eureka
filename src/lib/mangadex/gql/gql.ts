...
type Documents = {
	...
	"\n\tquery getMangaTitleOnlyQuery($mangaId: UUID!) {\n\t\tmanga {\n\t\t\tget(id: $mangaId) {\n\t\t\t\tid\n\t\t\t\tattributes {\n\t\t\t\t\ttitle\n\t\t\t\t}\n\t\t\t}\n\t\t}\n\t}\n": typeof types.GetMangaTitleOnlyQueryDocument;
	...
	"\n\tfragment MangaLinksFrag on MangaLinks {\n\t\thasNoLinks\n\t\tamazon\n\t\tanilist\n\t\tanimePlanet\n\t\tbookWalker\n\t\tcdJapan\n\t\tebookJapan\n\t\tenglishTranslation\n\t\tkitsu\n\t\tmangaUpdates\n\t\tmyAnimeList\n\t\tnovelUpdates\n\t\traw\n\t}\n": typeof types.MangaLinksFragFragmentDoc;
	...
	"\n\tfragment ClientInfoFrag on ClientInfo {\n\t\tclientId\n\t\tclientSecret\n\t}\n": typeof types.ClientInfoFragFragmentDoc;
...
const documents: Documents = {
	...
	"\n\tfragment ContentProfileItem on ContentProfile {\n\t\toriginalLanguages\n\t\tpublicationDemographic\n\t\tincludedTags\n\t\tincludedTagsMode\n\t\texcludedTags\n\t\texcludedTagsMode\n\t\tstatus\n\t\texcludedOriginalLanguage\n\t\ttranslatedLanguages\n\t\tcontentRating\n\t\texcludedGroups\n\t\texcludedUploaders\n\t}\n":
		types.ContentProfileItemFragmentDoc,
	"\n\tsubscription watchContentProfiles {\n\t\twatchContentProfiles {\n\t\t\tname\n\t\t\tvalue {\n\t\t\t\t...ContentProfileItem\n\t\t\t}\n\t\t}\n\t}\n":
	...
	"\n\tquery listBlacklistLabels($params: BlacklistLabelsListParam) {\n\t\tblacklist {\n\t\t\tlabels {\n\t\t\t\tlist(params: $params) {\n\t\t\t\t\toffset\n\t\t\t\t\tlimit\n\t\t\t\t\ttotal\n\t\t\t\t\tdata {\n\t\t\t\t\t\tid\n\t\t\t\t\t\tname\n\t\t\t\t\t\tcreateDate\n\t\t\t\t\t\tdescription\n\t\t\t\t\t}\n\t\t\t\t}\n\t\t\t}\n\t\t}\n\t}\n":
		types.ListBlacklistLabelsDocument,
	"\n\tquery getBlacklistLabel($id: UUID!) {\n\t\tblacklist {\n\t\t\tlabels {\n\t\t\t\tget(id: $id) {\n\t\t\t\t\tid\n\t\t\t\t\tname\n\t\t\t\t\tcreateDate\n\t\t\t\t\tdescription\n\t\t\t\t}\n\t\t\t}\n\t\t}\n\t}\n":
		types.GetBlacklistLabelDocument,
	"\n\tquery getBlacklistLabelsByIds($ids: [UUID!]!) {\n\t\tblacklist {\n\t\t\tlabels {\n\t\t\t\tgetByIds(ids: $ids) {\n\t\t\t\t\tid\n\t\t\t\t\tname\n\t\t\t\t\tcreateDate\n\t\t\t\t\tdescription\n\t\t\t\t}\n\t\t\t}\n\t\t}\n\t}\n":
		types.GetBlacklistLabelsByIdsDocument,
	"\n\tmutation createBlacklistLabel($param: CreateBlacklistLabelParam!) {\n\t\tblacklist {\n\t\t\tlabels {\n\t\t\t\tcreateLabel(param: $param) {\n\t\t\t\t\tid\n\t\t\t\t}\n\t\t\t}\n\t\t}\n\t}\n":
		types.CreateBlacklistLabelDocument,
	"\n\tmutation linkBlacklistLabelsAuthorsArtists(\n\t\t$labelIds: [UUID!]!\n\t\t$authorIds: [UUID!]!\n\t\t$notes: String\n\t) {\n\t\tblacklist {\n\t\t\tlabels {\n\t\t\t\tlinkAuthorsArtists(authorIds: $authorIds, labelIds: $labelIds, notes: $notes)\n\t\t\t}\n\t\t}\n\t}\n":
		types.LinkBlacklistLabelsAuthorsArtistsDocument,
	"\n\tmutation linkBlacklistLabelsScanlationGroups(\n\t\t$scanlationGroupIds: [UUID!]!\n\t\t$labelIds: [UUID!]!\n\t\t$notes: String\n\t) {\n\t\tblacklist {\n\t\t\tlabels {\n\t\t\t\tlinkScanlationGroups(\n\t\t\t\t\tlabelIds: $labelIds\n\t\t\t\t\tscanlationGroupsIds: $scanlationGroupIds\n\t\t\t\t\tnotes: $notes\n\t\t\t\t)\n\t\t\t}\n\t\t}\n\t}\n":
	...
	"\n\tmutation downloadCoversLocaly($ids: [UUID!]!) {\n\t\tcover {\n\t\t\tdownloadCovers(ids: $ids)\n\t\t}\n\t}\n":
		types.DownloadCoversLocalyDocument,
	"\n\tsubscription listenToMangaTasksIDs {\n\t\twatchMangaTasksList\n\t}\n":
	...
	"\n\tquery onlyScanlationGroupName($scanGroupsId: [UUID!]!) {\n\t\tscanlationGroup {\n\t\t\tlist(params: { groupIds: $scanGroupsId }) {\n\t\t\t\tdata {\n\t\t\t\t\tid\n\t\t\t\t\tattributes {\n\t\t\t\t\t\tname\n\t\t\t\t\t}\n\t\t\t\t}\n\t\t\t}\n\t\t}\n\t}\n":
		types.OnlyScanlationGroupNameDocument,
	"\n\tquery scanalationGroupSearch($params: ScanlationGroupListParams!) {\n\t\tscanlationGroup {\n\t\t\tlist(params: $params) {\n\t\t\t\tlimit\n\t\t\t\toffset\n\t\t\t\ttotal\n\t\t\t\tdata {\n\t\t\t\t\tid\n\t\t\t\t\tattributes {\n\t\t\t\t\t\tname\n\t\t\t\t\t\tdiscord\n\t\t\t\t\t\twebsite\n\t\t\t\t\t}\n\t\t\t\t\trelationships {\n\t\t\t\t\t\tleader {\n\t\t\t\t\t\t\tid\n\t\t\t\t\t\t\tattributes {\n\t\t\t\t\t\t\t\tusername\n\t\t\t\t\t\t\t}\n\t\t\t\t\t\t}\n\t\t\t\t\t\tmembers {\n\t\t\t\t\t\t\tid\n\t\t\t\t\t\t}\n\t\t\t\t\t}\n\t\t\t\t}\n\t\t\t}\n\t\t}\n\t}\n":
		types.ScanalationGroupSearchDocument,
	"\n\tquery groupSearchAndGetNameOnly($limit: Int, $offset: Int, $name: String) {\n\t\tscanlationGroup {\n\t\t\tlist(params: { limit: $limit, offset: $offset, name: $name }) {\n\t\t\t\tdata {\n\t\t\t\t\tid\n\t\t\t\t\tattributes {\n\t\t\t\t\t\tname\n\t\t\t\t\t}\n\t\t\t\t}\n\t\t\t\tlimit\n\t\t\t\toffset\n\t\t\t\ttotal\n\t\t\t}\n\t\t}\n\t}\n":
		types.GroupSearchAndGetNameOnlyDocument,
	"\n\tquery userFollowedGroups($offset: Int, $limit: Int) {\n\t\tfollows {\n\t\t\tgroups(params: { limit: $limit, offset: $offset }) {\n\t\t\t\tdata {\n\t\t\t\t\tid\n\t\t\t\t\tattributes {\n\t\t\t\t\t\tname\n\t\t\t\t\t\taltNames\n\t\t\t\t\t\tdiscord\n\t\t\t\t\t\tircServer\n\t\t\t\t\t\tircChannel\n\t\t\t\t\t\tofficial\n\t\t\t\t\t\tverified\n\t\t\t\t\t\twebsite\n\t\t\t\t\t\ttwitter\n\t\t\t\t\t\tmangaUpdates\n\t\t\t\t\t\tcontactEmail\n\t\t\t\t\t}\n\t\t\t\t\trelationships {\n\t\t\t\t\t\tleader {\n\t\t\t\t\t\t\tid\n\t\t\t\t\t\t\tattributes {\n\t\t\t\t\t\t\t\tusername\n\t\t\t\t\t\t\t\troles\n\t\t\t\t\t\t\t}\n\t\t\t\t\t\t}\n\t\t\t\t\t\tmembersLen\n\t\t\t\t\t}\n\t\t\t\t}\n\t\t\t\tlimit\n\t\t\t\toffset\n\t\t\t\ttotal\n\t\t\t}\n\t\t}\n\t}\n":
		types.UserFollowedGroupsDocument,
	"\n\tsubscription watchOnlyUnreadSub {\n\t\twatchHideReadTitles\n\t}\n":
		types.WatchOnlyUnreadSubDocument,
	"\n\tmutation setHideReadTitle($hide: Boolean!) {\n\t\tuserOption {\n\t\t\tsetHideReadTitles(hide: $hide)\n\t\t}\n\t}\n":
		types.SetHideReadTitleDocument,
	"\n\tquery currentUserLibraryCompleted($param: UserLibrarySectionParam) {\n\t\tlibrary {\n\t\t\tcompleted(param: $param) {\n\t\t\t\tlimit\n\t\t\t\toffset\n\t\t\t\ttotal\n\t\t\t\tdata {\n\t\t\t\t\tid\n\t\t\t\t\tattributes {\n\t\t\t\t\t\tdescription\n\t\t\t\t\t\tyear\n\t\t\t\t\t\ttitle\n\t\t\t\t\t\tstatus\n\t\t\t\t\t\tstate\n\t\t\t\t\t\toriginalLanguage\n\t\t\t\t\t\ttags {\n\t\t\t\t\t\t\tid\n\t\t\t\t\t\t\tattributes {\n\t\t\t\t\t\t\t\tname\n\t\t\t\t\t\t\t}\n\t\t\t\t\t\t}\n\t\t\t\t\t\tcontentRating\n\t\t\t\t\t\tpublicationDemographic\n\t\t\t\t\t}\n\t\t\t\t\trelationships {\n\t\t\t\t\t\tcoverArt {\n\t\t\t\t\t\t\tid\n\t\t\t\t\t\t\tattributes {\n\t\t\t\t\t\t\t\tdescription\n\t\t\t\t\t\t\t\tfileName\n\t\t\t\t\t\t\t}\n\t\t\t\t\t\t}\n\t\t\t\t\t}\n\t\t\t\t}\n\t\t\t}\n\t\t}\n\t}\n":
	...
	"\n\tmutation assembleCustomListsTitlesIntoOne(\n\t\t$ids: [UUID!]!\n\t\t$newListName: String!\n\t\t$visibility: CustomListVisibility\n\t\t$filterContent: Boolean\n\t) {\n\t\tcustomList {\n\t\t\tassembleCustomListsIntoOne(\n\t\t\t\ttoAssemble: $ids\n\t\t\t\tname: $newListName\n\t\t\t\tvisibility: $visibility\n\t\t\t\tfilterContent: $filterContent\n\t\t\t) {\n\t\t\t\tid\n\t\t\t\tattributes {\n\t\t\t\t\tvisibility\n\t\t\t\t}\n\t\t\t}\n\t\t}\n\t}\n":
		types.AssembleCustomListsTitlesIntoOneDocument,
	"\n\tquery currentUserCustomLists($params: CurrentLoggedLists!) {\n\t\tcustomList {\n\t\t\tcurrentLoggedLists(params: $params) {\n\t\t\t\tlimit\n\t\t\t\toffset\n\t\t\t\ttotal\n\t\t\t\tdata {\n\t\t\t\t\tid\n\t\t\t\t\tattributes {\n\t\t\t\t\t\tname\n\t\t\t\t\t\tvisibility\n\t\t\t\t\t}\n\t\t\t\t\trelationships {\n\t\t\t\t\t\ttitlesIds\n\t\t\t\t\t}\n\t\t\t\t}\n\t\t\t}\n\t\t}\n\t}\n":
	...
	"\n\tquery getCustomListInfoByBatch($ids: [UUID!]!, $private: Boolean) {\n\t\tcustomList {\n\t\t\tgetCustomListBatch(ids: $ids, private: $private) {\n\t\t\t\tid\n\t\t\t\tattributes {\n\t\t\t\t\tname\n\t\t\t\t\tvisibility\n\t\t\t\t}\n\t\t\t\trelationships {\n\t\t\t\t\ttitlesIds\n\t\t\t\t}\n\t\t\t}\n\t\t}\n\t}\n":
		types.GetCustomListInfoByBatchDocument,
	"\n\tmutation deleteCustomListMutation($id: UUID!) {\n\t\tcustomList {\n\t\t\tdelete(id: $id)\n\t\t}\n\t}\n":
	...
	"\n\tsubscription mangaInfoPositionGQLDoc {\n\t\twatchMangaInfosPosition\n\t}\n":
		types.MangaInfoPositionGqlDocDocument,
	"\n\tmutation setMangaInfoPosition($position: MangaInfosPositions!) {\n\t\tuserOption {\n\t\t\tsetMangaInfosPosition(position: $position)\n\t\t}\n\t}\n":
		types.SetMangaInfoPositionDocument,
	"\n\tsubscription listenToChapterReadMarker($id: UUID!) {\n\t\twatchReadMarker(chapterId: $id)\n\t}\n":
	...
	"\n\tfragment ReportAttributesFrag on ReportAttributes {\n\t\tdetails\n\t\tobjectId\n\t\tstatus\n\t\tcreatedAt\n\t}\n":
		types.ReportAttributesFragFragmentDoc,
	"\n\tfragment ReportReasonAttributesFrag on ReportReasonAttributes {\n\t\treason\n\t\tcategory\n\t\tdetailsRequired\n\t}\n":
		types.ReportReasonAttributesFragFragmentDoc,
	"\n\tquery currentUserReports($params: ListReportParams) {\n\t\treport {\n\t\t\tlist(params: $params) {\n\t\t\t\tlimit\n\t\t\t\toffset\n\t\t\t\ttotal\n\t\t\t\tdata {\n\t\t\t\t\tid\n\t\t\t\t\tattributes {\n\t\t\t\t\t\t...ReportAttributesFrag\n\t\t\t\t\t}\n\t\t\t\t}\n\t\t\t}\n\t\t}\n\t}\n":
	...
	"\n\tmutation downloadTitleWithExtras($mangaId: UUID!, $extras: MangaDownloadExtras) {\n\t\tmanga {\n\t\t\tdownload(extras: $extras, id: $mangaId) {\n\t\t\t\tisDownloaded\n\t\t\t\thasFailed\n\t\t\t}\n\t\t}\n\t}\n":
		types.DownloadTitleWithExtrasDocument,
	"\n\tmutation followTitleMutation($id: UUID!) {\n\t\tmanga {\n\t\t\tfollow(id: $id)\n\t\t}\n\t}\n":
	...
	"\n\tquery getMangaTitleOnlyQuery($mangaId: UUID!) {\n\t\tmanga {\n\t\t\tget(id: $mangaId) {\n\t\t\t\tid\n\t\t\t\tattributes {\n\t\t\t\t\ttitle\n\t\t\t\t}\n\t\t\t}\n\t\t}\n\t}\n":
		types.GetMangaTitleOnlyQueryDocument,
	"\n\tquery latestUploadsPageQuery(\n\t\t$offset: Int\n\t\t$limit: Int\n\t\t$disableScanlationGroupBlacklist: Boolean\n\t\t$disableUserBlacklist: Boolean\n\t\t$disableAuthorArtistBlacklist: Boolean\n\t) {\n\t\tchapter {\n\t\t\tlistWithGroupByManga(\n\t\t\t\tparam: {\n\t\t\t\t\tchapterListParams: {\n\t\t\t\t\t\tincludeEmptyPages: EXCLUDE\n\t\t\t\t\t\tincludeExternalUrl: EXCLUDE\n\t\t\t\t\t\tincludeFutureUpdates: EXCLUDE\n\t\t\t\t\t\tincludeFuturePublishAt: EXCLUDE\n\t\t\t\t\t\torder: { readableAt: DESCENDING }\n\t\t\t\t\t\toffset: $offset\n\t\t\t\t\t\tlimit: $limit\n\t\t\t\t\t}\n\t\t\t\t\tfeedContent: true\n\t\t\t\t\texcludeBlacklistedAuthorArtists: $disableAuthorArtistBlacklist\n\t\t\t\t\texcludeBlacklistedScansGroups: $disableScanlationGroupBlacklist\n\t\t\t\t\texcludeBlacklistedUsers: $disableUserBlacklist\n\t\t\t\t}\n\t\t\t) {\n\t\t\t\tlimit\n\t\t\t\toffset\n\t\t\t\ttotal\n\t\t\t\tdata {\n\t\t\t\t\tmanga {\n\t\t\t\t\t\tid\n\t\t\t\t\t\tattributes {\n\t\t\t\t\t\t\ttitle\n\t\t\t\t\t\t\toriginalLanguage\n\t\t\t\t\t\t\tlastVolume\n\t\t\t\t\t\t\tlastChapter\n\t\t\t\t\t\t}\n\t\t\t\t\t\trelationships {\n\t\t\t\t\t\t\tcoverArt {\n\t\t\t\t\t\t\t\tid\n\t\t\t\t\t\t\t\tattributes {\n\t\t\t\t\t\t\t\t\tfileName\n\t\t\t\t\t\t\t\t}\n\t\t\t\t\t\t\t}\n\t\t\t\t\t\t}\n\t\t\t\t\t}\n\t\t\t\t\tchapters {\n\t\t\t\t\t\tid\n\t\t\t\t\t\tattributes {\n\t\t\t\t\t\t\ttitle\n\t\t\t\t\t\t\tchapter\n\t\t\t\t\t\t\tvolume\n\t\t\t\t\t\t\ttranslatedLanguage\n\t\t\t\t\t\t\texternalUrl\n\t\t\t\t\t\t\tcreatedAt\n\t\t\t\t\t\t\treadableAt\n\t\t\t\t\t\t}\n\t\t\t\t\t\trelationships {\n\t\t\t\t\t\t\tscanlationGroups {\n\t\t\t\t\t\t\t\tid\n\t\t\t\t\t\t\t\tattributes {\n\t\t\t\t\t\t\t\t\tname\n\t\t\t\t\t\t\t\t}\n\t\t\t\t\t\t\t}\n\t\t\t\t\t\t\tuser {\n\t\t\t\t\t\t\t\tid\n\t\t\t\t\t\t\t\tattributes {\n\t\t\t\t\t\t\t\t\troles\n\t\t\t\t\t\t\t\t\tusername\n\t\t\t\t\t\t\t\t}\n\t\t\t\t\t\t\t}\n\t\t\t\t\t\t}\n\t\t\t\t\t}\n\t\t\t\t}\n\t\t\t}\n\t\t}\n\t}\n":
		types.LatestUploadsPageQueryDocument,
	"\n\tfragment MangaLinksFrag on MangaLinks {\n\t\thasNoLinks\n\t\tamazon\n\t\tanilist\n\t\tanimePlanet\n\t\tbookWalker\n\t\tcdJapan\n\t\tebookJapan\n\t\tenglishTranslation\n\t\tkitsu\n\t\tmangaUpdates\n\t\tmyAnimeList\n\t\tnovelUpdates\n\t\traw\n\t}\n":
		types.MangaLinksFragFragmentDoc,
	"\n\tquery randomTitle($options: MangaRandomParams) {\n\t\tmanga {\n\t\t\trandom(params: $options) {\n\t\t\t\tid\n\t\t\t}\n\t\t}\n\t}\n":
	...
	"\n\tfragment ClientInfoFrag on ClientInfo {\n\t\tclientId\n\t\tclientSecret\n\t}\n":
		types.ClientInfoFragFragmentDoc,
	"\n\tsubscription currentClientInfo {\n\t\twatchClientInfo {\n\t\t\t...ClientInfoFrag\n\t\t}\n\t}\n":
	...
	"\n\tmutation updateToastNotify($notify: Boolean!) {\n\t\tuserOption {\n\t\t\tsetToastNotify(notify: $notify)\n\t\t}\n\t}\n":
		types.UpdateToastNotifyDocument,
	"\n\tsubscription listenToToastNotifyStore {\n\t\twatchNotifyToast\n\t}\n":
		types.ListenToToastNotifyStoreDocument,
	"\n\tsubscription defaultThemeProfileSubscription {\n\t\twatchThemeProfileDefault {\n\t\t\t...MangaDexThemeFrag\n\t\t}\n\t}\n":
	...
	"\n\tfragment MangaDexThemeFrag on MangaDexTheme {\n\t\ttextColor\n\t\tmainBackground\n\t\taccents {\n\t\t\tdefault {\n\t\t\t\tdefault\n\t\t\t\thover\n\t\t\t\tactive\n\t\t\t}\n\t\t\tl1 {\n\t\t\t\tdefault\n\t\t\t\thover\n\t\t\t\tactive\n\t\t\t}\n\t\t\tl2 {\n\t\t\t\tdefault\n\t\t\t\thover\n\t\t\t\tactive\n\t\t\t}\n\t\t\tl3 {\n\t\t\t\tdefault\n\t\t\t\thover\n\t\t\t\tactive\n\t\t\t}\n\t\t\tl4 {\n\t\t\t\tdefault\n\t\t\t\thover\n\t\t\t\tactive\n\t\t\t}\n\t\t\tl5 {\n\t\t\t\tdefault\n\t\t\t\thover\n\t\t\t\tactive\n\t\t\t}\n\t\t}\n\t\tmidTone\n\t\tcontrast {\n\t\t\tl1\n\t\t}\n\t\tscrollbar {\n\t\t\tdefault\n\t\t\thovered\n\t\t}\n\t\tbutton {\n\t\t\tdefault\n\t\t\talternate\n\t\t}\n\t\tprimary {\n\t\t\tprimary\n\t\t\tprimary1\n\t\t\tprimary2\n\t\t}\n\t\tstatus {\n\t\t\tred\n\t\t\tgrey\n\t\t\tgreen\n\t\t\tyellow\n\t\t\tblue\n\t\t\tgrey\n\t\t\tpurple\n\t\t}\n\t\tindication {\n\t\t\tblue\n\t\t}\n\t\tdanger {\n\t\t\tdefault\n\t\t\tl1\n\t\t\tl2\n\t\t}\n\t}\n":
		types.MangaDexThemeFragFragmentDoc,
	"\n\tsubscription themeProfilesSubscription {\n\t\twatchThemesProfile {\n\t\t\tname\n\t\t\tvalue {\n\t\t\t\t...MangaDexThemeFrag\n\t\t\t}\n\t\t}\n\t}\n":
