use mangadex_api_input_types::follows::mangas::UserFollowedMangaParams;
...
impl SplittableParam for UserFollowedMangaParams {
    fn offset(&self) -> u32 {
...
impl SendableParam for UserFollowedMangaParams {
