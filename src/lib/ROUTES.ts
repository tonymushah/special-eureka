...
const PAGES = {
  ...
  "/mangadex/report": `/mangadex/report`,
  "/mangadex/settings": `/mangadex/settings`,
  "/mangadex/settings/auth": `/mangadex/settings/auth`,
  "/mangadex/settings/black-list": `/mangadex/settings/black-list`,
  ...
  "/mangadex/titles/library/export/csv": `/mangadex/titles/library/export/csv`,
  ...
  "/mangadex/upload/[id]": (params: { id: (string | number) }) => {
    return `/mangadex/upload/${params['id']}`
  },
