...
import { ContentProfileWarningMode, ContentRating, type ContentProfile, type ReadingStatus } from "@mangadex/gql/graphql";
...
export function getTitleConflictsFromMangaListContentItemProps({ title, library, profile: $profile, warningMode }: GetTitleConflictsFromMangaListContentItemPropsParams): ContentProfileConflicts | null {
...
export function updateTitleBlur(options: GetTitleConflictsFromMangaListContentItemPropsParams): MangaListContentItemProps {
