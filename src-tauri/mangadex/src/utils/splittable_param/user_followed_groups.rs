use mangadex_api_input_types::follows::groups::UserFollowedGroupsParams;
use mangadex_api_schema_rust::v5::GroupObject;

use crate::constants::MANGADEX_DEFAULT_LIMIT;

use super::{SendableParam, SplittableParam};

impl SplittableParam for UserFollowedGroupsParams {
    fn offset(&self) -> u32 {
...
impl SendableParam for UserFollowedGroupsParams {
