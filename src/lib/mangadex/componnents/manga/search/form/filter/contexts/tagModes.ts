...
export const {
	init: initMangaSearchTagModeContext,
	getReadonly: getMangaSearchTagModeContext,
	get: getMangaSearchTagModeContextWritable
} = generateContextStoresMethods<TagModes>("MANGA_SEARCH_TAG_MODES");
...
export function tagModeWritableToBoolWritable(
	writable: Writable<TagSearchMode>,
	trueValue: TagSearchMode = TagSearchMode.And
): Writable<boolean> {
