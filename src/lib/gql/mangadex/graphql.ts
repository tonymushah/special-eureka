...
export type FollowsQueries = {
  ...
  isFollowingLists: Scalars['Boolean']['output'];
  isFollowingMangas: Scalars['Boolean']['output'];
  isFollowingUser: Scalars['Boolean']['output'];
  lists: CustomListResults;
  mangas: MangaResults;
  users: UserResults;
};
...
export type FollowsQueriesIsFollowingListsArgs = {
  id: Scalars['UUID']['input'];
};


export type FollowsQueriesIsFollowingMangasArgs = {
  id: Scalars['UUID']['input'];
};
...
export type FollowsQueriesListsArgs = {
...
export type IsLoggedSubscription = { __typename?: 'Subscriptions', watchIsAppMounted: boolean };
